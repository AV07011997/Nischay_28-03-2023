...
#             # print(data)
#
#         data=bank_bank.objects.filter(customer_id=customer_id).values('txn_date', 'description', 'cheque_number', 'debit', 'credit', 'balance',
#                                          'account_name', 'account_number', 'mode', 'entity', 'source_of_trans',
#                                          'sub_mode', 'transaction_type', 'bank_name', 'lead_id', 'creation_time').annotate(
#                 from_date=bank_bank.Min('txn_date'),
#                 to_date=bank_bank.Max('txn_date'),
#                 num_entities=bank_bank.Count('entity', distinct=True)
#             )
#
#
#         for date in data:
