...
urlpatterns = [
    ...
    path('bank_customer_month_kpi/', analyze_views.bank_customer_month_kpi,
         name="bank_customer_month_kpi"),
    path('bank_customer_kpi/', analyze_views.bank_customer_kpi,
         name="bank_customer_kpi"),
    path('bank_customer_kpi_popup/', analyze_views.bck_popup, name="bck_popup"),
    ...
    path('bank_customer_month_kpi/<date>/<maxcredit>/<accno>/',
         analyze_views.maxcredit, name="maxcredit"),
    path('bureau_customer_kpi/', analyze_views.bureau_customer_kpi,
         name="bureau_customer_kpi"),
    path('bureau_customer_month_kpi/', analyze_views.bureau_customer_month_kpi,
         name="bureau_customer_month_kpi"),
    path('bank_entity_kpi/', analyze_views.bank_entity_kpi, name="bank_entity_kpi"),
    path('bank_entity_kpi_merge/', analyze_views.bank_entity_kpi_merge,
         name="bank_entity_kpi_merge"),
    ...
    path('bureau_customer_kpi/<cust_id>/',
         analyze_views.alladress, name="alladress"),
    path('bureau_customer_kpi/age/<cust_id>/', analyze_views.age, name="age"),
    path('statements/', analyze_views.statements, name='statements'),
    path('executivesummary/', analyze_views.executive_summary,
