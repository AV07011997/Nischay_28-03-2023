...
def fstype_extraction(filepath,scanned_flag):
    ...
    if scanned_flag == 0:
        ...
        #gets the raw string image data from the dictionary and wraps it in a bytesio object before using pil to open it
         ...
         image.save(r'/Users/Abhishek/Desktop/digitised/temp.png')
         img = Image.open(r'/Users/Abhishek/Desktop/digitised/temp.png')
         img = img.convert("L")
    ...
    if scanned_flag == 1:
        ...
        img.save(r'/Users/Abhishek/Desktop/digitised/temp.png')
        pytesseract.pytesseract.tesseract_cmd = "C:\\Program Files\\Tesseract-OCR\\tesseract.exe"
        result = pytesseract.image_to_string(img)  
